...
var rightWidth30 = rightWidth.dup({ width: xPercent30, x: 'screenOriginX+screenSizeX-' + xPercent30 })
var rightWidth40 = rightWidth.dup({ width: xPercent40, x: 'screenOriginX+screenSizeX-' + xPercent40 })
var rightWidth50 = rightWidth.dup({ width: xPercent50, x: 'screenOriginX+screenSizeX-' + xPercent50 })
var rightWidth60 = rightWidth.dup({ width: xPercent60, x: 'screenOriginX+screenSizeX-' + xPercent60 })
var rightWidth70 = rightWidth.dup({ width: xPercent70, x: 'screenOriginX+screenSizeX-' + xPercent70 })
var rightWidth80 = rightWidth.dup({ width: xPercent80, x: 'screenOriginX+screenSizeX-' + xPercent80 })
var rightWidth90 = rightWidth.dup({ width: xPercent90, x: 'screenOriginX+screenSizeX-' + xPercent90 })
var rightWidth100 = rightWidth.dup({ width: xPercent100, x: 'screenOriginX+screenSizeX-' + xPercent100 })
...
var bottomHeight30 = bottomHeight.dup({ height: yPercent30, y: 'screenOriginY+screenSizeY-' + yPercent30 })
var bottomHeight40 = bottomHeight.dup({ height: yPercent40, y: 'screenOriginY+screenSizeY-' + yPercent40 })
var bottomHeight50 = bottomHeight.dup({ height: yPercent50, y: 'screenOriginY+screenSizeY-' + yPercent50 })
var bottomHeight60 = bottomHeight.dup({ height: yPercent60, y: 'screenOriginY+screenSizeY-' + yPercent60 })
var bottomHeight70 = bottomHeight.dup({ height: yPercent70, y: 'screenOriginY+screenSizeY-' + yPercent70 })
var bottomHeight80 = bottomHeight.dup({ height: yPercent80, y: 'screenOriginY+screenSizeY-' + yPercent80 })
var bottomHeight90 = bottomHeight.dup({ height: yPercent90, y: 'screenOriginY+screenSizeY-' + yPercent90 })
var bottomHeight100 = bottomHeight.dup({ height: yPercent100, y: 'screenOriginY+screenSizeY-' + yPercent100 })
...
function defaultWindowSize(win, screen) {
	...
	if (isBigScreen(screen)) {
		move = defaultWindowSizeForBigScreen(move, win.app().name())
	}
...
function defaultWindowSizeForBigScreen(move, name) {
	switch (name) {
		case 'Code':
			move = move.dup({ width: 'screenSizeX*7/10', x: 'screenOriginX+screenSizeX-screenSizeX*7/10', screen })
			break
		default:
			move = move.dup({ width: 'screenSizeX*5/10', height: 'screenSizeY*8/10', screen })
			break
	}
	return move
}
